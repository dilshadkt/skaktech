...
function Contact() {
  return (
    <section className=" px-5 md:px-10 lg:px-12  h-fit w-full">
      <div className="max-w-screen-xl mx-auto  h-full pt-[80px] ">
        <div className="w-full grid gap-y-12 md:grid-cols-4 py-16 md:py-24">
          <div className=" order-2 md:order-1  col-span-3 flex flex-col">
            <p className="text-[#8D8D8D] md:text-xl">Locate us</p>
            <h2 className="font-semibold text-3xl md:text-6xl text-gray-800 mt-2">
              Let’s Talk
            </h2>
            <form action="" className="flex flex-col gap-y-6  md:w-[87%] mt-10">
              <input
                type="text"
                placeholder="Full Name*"
                className="p-3 border-b-2 text-sm md:text-base border-gray-800 outline-none"
              />
              ...
              <div className="flex items-end gap-x-6 ">
                <input
                  ...
                  text-sm md:text-base border-gray-800 outline-none"
                />
                <button className="border-b-8 text-xl font-semibold border-primary ">
                  Submit
                </button>
              </div>
            </form>
          ...
          <div className=" order-1  md:order-2 col-span-1 flex flex-col items-center">
            ...
            <p className="md:text-lg my-10 md:my-12  text-center font-medium md:w-[85%]">
